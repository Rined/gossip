...
import static com.rined.justtalk.Utils.normalize;
...
public class MainControllerTest {
    ...
    void mainPageTest() throws Exception {
        mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath(normalize("//div[@id='navbarSupportedContent']/div")).string("admin"));
    }
    ...
    void filterMessageList() throws Exception {
        mockMvc.perform(get("/main").param("filter", "some-tag"))
                .andDo(print())
                .andExpect(authenticated())
